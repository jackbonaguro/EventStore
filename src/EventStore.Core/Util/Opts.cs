...
namespace EventStore.Core.Util {
	public static class Opts {
		...
		public const string SslValidateMasterNodeDescr = "Whether to validate a master node's certificate when connecting to it as a slave or read-only replica.";
		public const bool SslValidateMasterNodeDefault = true;

		public const string SslValidateReplicasDescr = "Whether to require a valid certificate from slaves or read-only replicas when this node is master.";
		public const bool SslValidateReplicasDefault = true;
