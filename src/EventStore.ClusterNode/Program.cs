...
namespace EventStore.ClusterNode {
	public class Program : ProgramBase<ClusterNodeOptions> {
		...
		private static ClusterVNode BuildNode(ClusterNodeOptions options) {
			...
			var extTcp = options.DisableExternalTls ? new IPEndPoint(options.ExtIp, options.ExtTcpPort) : null;
			var extSecTcp = !options.DisableExternalTls ? new IPEndPoint(options.ExtIp, options.ExtTcpPort) : null;
			...
			var extTcpPortAdvertiseAs = options.DisableExternalTls ? options.ExtTcpPortAdvertiseAs : 0;
			var extSecTcpPortAdvertiseAs = !options.DisableExternalTls ? options.ExtTcpPortAdvertiseAs : 0;
